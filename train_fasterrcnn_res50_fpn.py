...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        utils.train_one_epoch1(model, optimizer, train_data_loader,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume', default='./save_weights/Fasterrcnn/resNetFpn-model-14.pth', type=str, help='resume from checkpoint')
    # 指定接着从哪个epoch数开始训练
