...
class FasterRCNNBase(nn.Module):
    ...
    def generate_proposal(self, images, targets=None):
        ...
        for i in range(num_images):
            proposal_boxes.append({'boxes': proposals[i]})

        proposal_boxes = self.transform.postprocess(proposal_boxes, images.image_sizes, original_image_sizes)
